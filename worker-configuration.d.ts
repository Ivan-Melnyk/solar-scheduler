/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 11f9b4c35345a798131679f7cf445ae4)
// Runtime types generated with workerd@1.20251213.0 2025-12-10 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "SolarScheduler";
	}
	interface Env {
		USERNAME: string;
		PASSWORD: string;
		SOLAR_SCHEDULER: DurableObjectNamespace<import("./worker/index").SolarScheduler>;
